...
| 2  | [Defining Comment Toxicity](https://github.com/allenbext/Portfolio/tree/main/Well%20Location%20for%20Oil%20Company%20) | NLP | *Python, Pandas, NumPy, Sklearn, CatBoost, BERT, Spacy, Nltk, TF-IDF, Tdqm* | Обучение модели классифицировать комментарии на позитивные и негативные |
