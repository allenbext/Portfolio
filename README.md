...
| 4  | [Predicting taxi orders for the next hour (time series)](https://github.com/allenbext/Portfolio/tree/main/Predicting%20taxi%20orders%20for%20the%20next%20hour%20(time%20series)) | ML | *Python, Pandas, NumPy, Sklearn, CatBoost, Statsmodels* | Training a model to predict the number of taxi orders for the next hour to attract more drivers during peak periods |
